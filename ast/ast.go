...
// allocate a buffer and write all the statements as strings into it
...
func (ls *LetStatement) String() string {
	...
	// TODO: remove nil checks once we implement parsing
	if ls.Value != nil {
...
type PrefixExpression struct {
	...
	Operator string      // the actual operator
	Right    Expression  // the expression to the right of the prefix operator
}
